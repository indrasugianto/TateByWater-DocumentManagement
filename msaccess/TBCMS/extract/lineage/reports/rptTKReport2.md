# Report Lineage: rptTKReport2

## Trigger Paths
- frmClientLedger -> cmdTKReportAR -> onClick -> cmdTKReportAR_Click (high confidence)
- Time Keeping -> cmdTKReport -> onClick -> cmdTKReport_Click (high confidence)
