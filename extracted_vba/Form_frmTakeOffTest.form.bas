...
'        Dim rs As Recordset
'        Set rs = CurrentDb.OpenRecordset("select * from tblTakeOffMonth where TakeOffMonthID = " & Me.TakeOffMonthID)
'        'rs.AddNew
'        rs.Edit
'
...
'        rs("TotalMKRev") = Nz(Form_frmTakeOffSubForm.SumMKRev, 0)
'        rs("TotalMKCommissions") = Nz(Form_frmTakeOffSubForm.SumMKCom, 0)
