# Report Lineage: rpt_TimeDetail_Comprehensive

## Trigger Paths
- No trigger path could be inferred from extracted forms/macros/VBA.

## Data Lineage
- RecordSource: `qryInvoiceComprehensiveTimeDetail`
- RecordSourceType: `saved-query`
- Involved Queries: qryInvoiceComprehensiveTimeDetail, qryInvoiceAttachRPT
