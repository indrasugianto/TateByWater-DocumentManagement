# Table: vwStmtTrustRPT1 *(linked)*

**Linked source:** `ODBC;DRIVER=SQL Server;SERVER=awsql2022dev;APP=Microsoft Office;DATABASE=TateBywater` → `dbo.vwStmtTrustRPT1`
...
| 101 | SSMA_TimeStamp | Binary | 8 | yes | — | — | — |
| 102 | SumOfDebit | Currency | 8 | yes | — | — | — |
| 103 | SumOfCredit | Currency | 8 | yes | — | — | — |
| 104 | Balance | Currency | 8 | yes | — | — | — |
| 105 | TrustAccountID | Long | 4 | yes | — | — | — |
| 106 | TDate | DateTime | 8 | yes | — | — | — |
| 107 | TMatter | Memo | — | yes | — | — | allows zero-length string |
| 108 | Debit | Currency | 8 | yes | — | — | — |
| 109 | Credit | Currency | 8 | yes | — | — | — |
| 110 | CheckNumber | Text | 255 | yes | — | — | allows zero-length string |
| 111 | Case No | Memo | — | yes | — | — | allows zero-length string |
| 112 | CheckCashed | Boolean | 1 | yes | — | — | — |
| 113 | DepCleared | Boolean | 1 | yes | — | — | — |
| 114 | Reconciled | Boolean | 1 | yes | — | — | — |
| 115 | OrderNr | Long | 4 | yes | — | — | — |
| 116 | Name | Memo | — | no | — | — | allows zero-length string |
| 117 | FileNumber | Memo | — | yes | — | — | allows zero-length string |
