# Table: tblCase *(linked)*

**Linked source:** `ODBC;DRIVER=SQL Server;SERVER=awsql2022dev;APP=Microsoft Office;DATABASE=TateBywater` → `dbo.tblCase`
...
| 102 | PartnerRate | Currency | 8 | yes | — | — | — |
| 103 | AssocRate | Currency | 8 | yes | — | — | — |
| 104 | FileLocation | Text | 50 | yes | — | — | allows zero-length string |
...
|-------|--------|---------|--------|---------|
| tblCase$PrimaryKey | CaseID | yes | yes | no |
