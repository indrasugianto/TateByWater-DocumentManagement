# Table: vwInvoiceRPT1 *(linked)*

**Linked source:** `ODBC;DRIVER=SQL Server;SERVER=awsql2022dev;APP=Microsoft Office;DATABASE=TateBywater` → `dbo.vwInvoiceRPT1`
...
| 102 | Balance | Currency | 8 | yes | — | — | — |
| 103 | MatterID | Long | 4 | yes | — | — | — |
| 104 | Date2 | DateTime | 8 | yes | — | — | — |
| 105 | Pay_Outlay | Memo | — | yes | — | — | allows zero-length string |
| 106 | Charge | Currency | 8 | yes | — | — | — |
| 107 | Payment | Currency | 8 | yes | — | — | — |
| 108 | Case No | Memo | — | yes | — | — | allows zero-length string |
| 109 | Balance Due Date | DateTime | 8 | yes | — | — | — |
| 110 | Past Due | Boolean | 1 | yes | — | — | — |
| 111 | Long Term Collections | Boolean | 1 | yes | — | — | — |
| 112 | chkBalanceDue | Boolean | 1 | yes | — | — | — |
| 113 | Billing Notes | Memo | — | yes | — | — | allows zero-length string |
| 114 | RunningDebit | Currency | 8 | yes | — | — | — |
| 115 | RunningCredit | Currency | 8 | yes | — | — | — |
| 116 | RunningBalance | Currency | 8 | yes | — | — | — |
| 117 | OrderNr | Long | 4 | yes | — | — | — |
